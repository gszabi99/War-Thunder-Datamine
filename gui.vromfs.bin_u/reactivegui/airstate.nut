...
let helicopterState = {
  ...
  AamTimeToHit = Computed(@() AamState.value.timeToHit),
  ...
  GuidedBombsTimeToHit = Computed(@() GuidedBombsState.value.timeToHit),
...
interop.updateAam <- function(count, seconds, timeToHit, selected, name, actualCount) {
