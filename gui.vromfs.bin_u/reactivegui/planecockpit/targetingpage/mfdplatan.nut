...
from "%rGui/airState.nut" import TurretYaw, TurretPitch
from "%rGui/planeState/planeToolsState.nut" import AimLockDist, AimLockValid, RocketMode, BombingMode, TimeBeforeBombRelease
from "%rGui/hud/targetTrackerState.nut" import IsTargetTracked
from "%rGui/planeState/planeWeaponState.nut" import CurWeaponName
  ...
  children = [
    {
      ...
      pos = const [pw(-320), -baseFontSize * 0.5]
      rendObj = ROBJ_TEXT
      color = baseColor
      font = Fonts.ils31
