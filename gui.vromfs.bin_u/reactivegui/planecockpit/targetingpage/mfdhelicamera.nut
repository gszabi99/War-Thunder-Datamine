from "%rGui/airHudElems.nut" import paramsTable, turretAngles, launchDistanceMax, sight, rangeFinder, lockSight, targetSize
from "%rGui/airState.nut" import IsMfdSightHudVisible, MfdSightMask, MfdSightPosSize, MfdFontScale, SecondaryMask, TertiaryMask, HudParamColor
...
let mfdSightParamsTable = paramsTable(MfdSightMask, SecondaryMask, TertiaryMask,
  hdpx(250), hdpx(28),
