...
from "%rGui/planeState/planeFlyState.nut" import Roll, ClimbSpeed, Speed, Altitude, Tangage, CompassValue, Overload
from "%rGui/planeIlses/ilsConstants.nut" import mpsToKmh, weaponTriggerName
from "%rGui/hud/targetTrackerState.nut" import TargetRadius, TargetX, TargetY
from "%rGui/planeState/planeToolsState.nut" import AimLockDist, AimLockValid, RocketMode, BombCCIPMode, MfdCameraZoom
from "%rGui/airState.nut" import IsInsideLaunchZoneYawPitch, IsInsideLaunchZoneDist, TurretYaw, TurretPitch, RocketsSalvo, BombsSalvo
from "%rGui/planeState/planeWeaponState.nut" import CurWeaponName, ShellCnt, SelectedTrigger, HasOperatedShell
from "%rGui/rocketAamAimState.nut" import GuidanceLockState
from "%sqstd/math_ex.nut" import degToRad
from "math" import sin, cos, PI, fabs, round
...
let labels = {
  ...
  children = [
    ...
    }
    {
      ...
      pos = const [pw(83), ph(2)]
    }
    {
      rendObj = ROBJ_TEXT
      size = SIZE_TO_CONTENT
      pos = const [pw(12), ph(2)]
      color = whiteColor
      font = Fonts.ils31
      fontSize = baseFontSize
      text = "ПЛТ"
