from "%rGui/planeState/planeWeaponState.nut" import WeaponSlots, WeaponSlotsCnt, WeaponSlotsName, WeaponSlotsTrigger, WeaponSlotActive, SlotCount
  ...
  foreach (i, weaponSlot in WeaponSlotsV) {
    ...
    if (i < count)
      numbers.append(
        {
          rendObj = ROBJ_SOLID
          size = const [baseLineWidth, ph(10)]
