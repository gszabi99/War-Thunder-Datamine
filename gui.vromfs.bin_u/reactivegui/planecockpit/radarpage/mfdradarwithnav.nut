...
from "%rGui/planeState/planeFlyState.nut" import Altitude, Roll
from "%rGui/radarState.nut" import DistanceMax, MfdRadarColor, Irst, TargetsTrigger, HasDistanceScale, HasAzimuthScale, Distance
