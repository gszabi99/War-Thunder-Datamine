...
from "%rGui/planeState/planeWeaponState.nut" import WeaponSlots, WeaponSlotsTrigger, WeaponSlotsCnt, SelectedWeapSlot, WeaponSlotsTotalCnt, WeaponSlotsName, WeaponSlotsBulletId
...
let { CannonCount } = require("%rGui/airState.nut")
