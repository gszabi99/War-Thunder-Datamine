...
from "%rGui/planeState/planeFlyState.nut" import Speed, Altitude, CompassValue, Mach, FuelConsume, FuelInternal, FuelTotal
  , RpmRel, RpmRel1, WaterTemp, WaterTemp1, Nozzle0, OilTemp0, Rpm
  , Rpm1, OilPress0, OilPress1, BarAltitude
from "%rGui/planeIlses/ilsConstants.nut" import mpsToKnots, metrToFeet
from "%sqstd/math.nut" import round_by_value, round
from "dagor.math" import Point2, IPoint3
