...
let sraam = @(pos, selected = false, size = [5, 22]) {
...
let targetingPod = @(pos, size = [25, 20]) {
  size = [pw(size[0]), ph(size[1])]
  pos = [pw(pos[0]), ph(pos[1])]
  rendObj = ROBJ_VECTOR_CANVAS
  fillColor = Color(0, 0, 0, 255)
...
let bomb = @(pos, selected = false, size = [4, 20]) {
  size = [pw(size[0]), ph(size[1])]
  pos = [pw(pos[0]), ph(pos[1])]
  rendObj = ROBJ_VECTOR_CANVAS
  fillColor = (selected) ? Color(0, 255, 255, 255) : Color(0, 0, 0, 255)
...
let lgb = @(pos, selected = false, size = [4, 20]) {
  size = [pw(size[0]), ph(size[1])]
  pos = [pw(pos[0]), ph(pos[1])]
  rendObj = ROBJ_VECTOR_CANVAS
  fillColor = (selected) ? Color(0, 255, 255, 255) : Color(0, 0, 0, 255)
