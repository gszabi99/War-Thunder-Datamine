...
::gui_handlers.InstantDomination <- class extends ::gui_handlers.BaseGuiHandlerWT
{
  ...
  function initGamercardDrawerHandler()
  {
    ...
    this.registerSubHandler(gamercardDrawerHandler)
  }
  ...
  function initToBattleButton()
  {
    ...
    if (toBattleNest)
    {
      ...
      toBattleButtonObj = this.rootHandlerWeak.scene.findObject("to_battle_button")
    ...
    gameModeChangeButtonObj = this.rootHandlerWeak.scene.findObject("game_mode_change_button")
    ...
    newGameModesWidgetsPlaceObj = this.rootHandlerWeak.scene.findObject("new_game_modes_widget_place")
  ...
  function updateUnseenGameModesCounter()
  {
    ...
    if (!newGameModeIconWidget)
      newGameModeIconWidget = ::NewIconWidget(this.guiScene, newGameModesWidgetsPlaceObj)
  ...
  function onCountrySelectAction()
  {
    ...
    setCurCountry(profileCountrySq.value)
  ...
  function checkQueue(func)
  {
    ...
    this.checkedModifyQueue(queueMask, func, restoreQueueParams)
  }
  ...
  onEventOpenGameModeSelect = @(_p) openGameModeSelect()
