...
::ItemsManager.getShopVisibleSeenIds <- function getShopVisibleSeenIds()
{
  if (!this.shopVisibleSeenIds)
    this.shopVisibleSeenIds = getShopList(this.checkItemsMaskFeatures(itemType.INVENTORY_ALL),
...
::ItemsManager.onEventExtPricesChanged <- @(_p) markItemsDefsListUpdateDelayed()
...
::ItemsManager.getInventoryVisibleSeenIds <- function getInventoryVisibleSeenIds()
{
  ...
  {
    let itemsList = getInventoryListByShopMask(this.checkItemsMaskFeatures(itemType.INVENTORY_ALL))
...
::ItemsManager.onEventExtInventoryChanged        <- @(_p) markInventoryUpdateDelayed()
::ItemsManager.onEventSendingItemsChanged        <- @(_p) markInventoryUpdateDelayed()
::ItemsManager.onEventTourRegistrationComplete   <- @(_p) markInventoryUpdate()
