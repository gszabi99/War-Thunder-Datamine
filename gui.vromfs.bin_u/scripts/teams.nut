...
{
  return enums.getCachedType("code", code, this.cache.byCode, this, NONE)
}

::g_team.getTeamByCountriesOption <- function getTeamByCountriesOption(optionId)
{
  return enums.getCachedType("teamCountriesOption", optionId, this.cache.byCountriesOption, this, NONE)
}
