...
local function receiveUnlockRewards(unlockName, stage, cb = null, taskOptions = {}) {
  ...
  local taskId = ::char_send_custom_action("cln_userstat_grant_rewards",
    ...
    -1)
  ::g_tasker.addTask(taskId, taskOptions, resultCb, @(result) cb?(result), TASK_CB_TYPE.REQUEST_DATA)
