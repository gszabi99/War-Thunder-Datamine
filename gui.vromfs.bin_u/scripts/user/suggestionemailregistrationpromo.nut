...
let { launchEmailRegistration, canEmailRegistration } = require("%scripts/user/suggestionEmailRegistration.nut")
...
const promoButtonId = "email_registration_mainmenu_button"
