...
from "%sqStdLibs/helpers/u.nut" import wrapIdxInArrayLen
from "%scripts/sqDagui/daguiNativeApi.nut" import *
from "types" import Float, Integer, String, Array
...
function setPopupMenuPosAndAlign(parentObjOrPos, defAlign, menuObj, params = null) {
  ...
  else if ((parentObjOrPos instanceof Array) && parentObjOrPos.len() == 2) {
