...
registerRespondent("get_spawn_score_type_mul", get_spawn_score_type_mul)
registerRespondent("get_unit_spawn_score_weapon_mul", get_unit_spawn_score_weapon_mul)
