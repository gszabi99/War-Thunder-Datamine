...
enumsAddTypes(g_mission_type, {
  ...
  A_NUKE = {  
    ...
    objectives = MISSION_OBJECTIVE.KILLS_AIR | MISSION_OBJECTIVE.KILLS_GROUND_AI | MISSION_OBJECTIVE.ZONE_BOMBING_NUKE
    objectivesWw = MISSION_OBJECTIVE.KILLS_AIR | MISSION_OBJECTIVE.KILLS_GROUND_AI | MISSION_OBJECTIVE.ZONE_BOMBING_NUKE
    filterGroup = MISSION_GROUP.GROUND_STRIKE
  }
