...
from "hudActionBarConst" import EII_SMOKE_GRENADE, EII_SMOKE_SCREEN, EII_ARTILLERY_TARGET, EII_SPECIAL_UNIT, EII_MEDICALKIT, EII_TERRAFORM, EII_WINCH
  , EII_WINCH_ATTACH, EII_WINCH_DETACH, EII_EXTINGUISHER, EII_TOOLKIT, EII_REPAIR_BREACHES, EII_SPEED_BOOSTER, EII_SUBMARINE_SONAR
  , EII_TORPEDO_SENSOR, EII_AUTO_TURRET, EII_SUPPORT_PLANE, EII_SUPPORT_PLANE_2, EII_SUPPORT_PLANE_3, EII_SUPPORT_PLANE_4, EII_SUPPORT_PLANE_CHANGE
  , EII_SUPPORT_PLANE_GROUP_ATTACK, EII_STEALTH, EII_LOCK, EII_NIGHT_VISION, EII_SIGHT_STABILIZATION, EII_SIGHT_STABILIZATION_OFF, EII_SUPPORT_PLANE_ORBITING
  , EII_UGV, EII_UNLIMITED_CONTROL, EII_GUIDANCE_MODE, EII_DESIGNATE_TARGET, EII_PERISCOPE, EII_SELECT_SPECIAL_WEAPON, EII_MISSION_SUPPORT_PLANE
  , EII_SUPPORT_PLANE_GROUP_RETURN, EII_BUILDING, EII_SLAVE_UNIT_SPAWN, EII_SLAVE_UNIT_SWITCH, EII_ANTI_AIR_COMPLEX_MENU, EII_SHIP_DAMAGE_CONTROL, EII_SLAVE_UNIT_STATUS
