...
//-------------------------------------------------------
  ...
  }
  {
    ...
    filterHide = [globalEnv.EM_MOUSE_AIM]
    showFunc = @() ::g_controls_utils.getMouseUsageMask() & AIR_MOUSE_USAGE.JOYSTICK
    value = @(_joyParams) 100.0*::get_option_multiplier(OPTION_HELICOPTER_MOUSE_JOYSTICK_DEADZONE) / ::maxMouseJoystickDeadZone
    setValue = @(_joyParams, objValue) ::set_option_multiplier(OPTION_HELICOPTER_MOUSE_JOYSTICK_DEADZONE,
  ...
  }
  {
    ...
    filterHide = [globalEnv.EM_MOUSE_AIM]
    showFunc = @() ::g_controls_utils.getMouseUsageMask() & (AIR_MOUSE_USAGE.JOYSTICK | AIR_MOUSE_USAGE.RELATIVE)
    value = @(_joyParams) 100.0*::get_option_multiplier(OPTION_HELICOPTER_MOUSE_AILERON_AILERON_FACTOR) / ::maxMouseJoystickAileron
    setValue = @(_joyParams, objValue) ::set_option_multiplier(OPTION_HELICOPTER_MOUSE_AILERON_AILERON_FACTOR,
  ...
  }
  {
    ...
    filterHide = [globalEnv.EM_MOUSE_AIM]
    showFunc = @() ::g_controls_utils.getMouseUsageMask() & (AIR_MOUSE_USAGE.JOYSTICK | AIR_MOUSE_USAGE.RELATIVE)
    value = @(_joyParams) 100.0*::get_option_multiplier(OPTION_HELICOPTER_MOUSE_AILERON_RUDDER_FACTOR) / ::maxMouseJoystickRudder
    setValue = @(_joyParams, objValue) ::set_option_multiplier(OPTION_HELICOPTER_MOUSE_AILERON_RUDDER_FACTOR,
