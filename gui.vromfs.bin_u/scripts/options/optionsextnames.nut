from "guiOptions" import addOptionMode, addUserOption
...
let optList = [
  ...
  "USEROPT_SPEECH_TYPE"
  "USEROPT_USE_SPECIAL_SPEECH_LANGUAGE"
  "USEROPT_USE_TRACKIR_ZOOM"
  "USEROPT_INDICATED_SPEED_TYPE"
  "USEROPT_INDICATED_ALTITUDE_TYPE"
  "USEROPT_RADAR_ALTITUDE_ALERT"
  "USEROPT_INVERTY"
  "USEROPT_INVERTY_TANK"
  "USEROPT_INVERTY_HUMAN"
  ...
  "USEROPT_MEASUREUNITS_DIST_SHORT"
  ...
  "USEROPT_SOUND_SPEAKERS_WIDE_SNAPSHOT"
  ...
  "USEROPT_BULLETS_WEAPON1"
  "USEROPT_BULLETS_WEAPON2"
  "USEROPT_BULLETS_WEAPON3"
  "USEROPT_BULLETS_WEAPON4"
  "USEROPT_BULLETS_WEAPON5"
  "USEROPT_SKIN"
  ...
  "USEROPT_ALLOW_WEB_UI"
  "USEROPT_HAS_TEAM_DESIGNATION"
  ...
  "USEROPT_USE_RECTANGULAR_RADAR_INDICATOR_FOR_TANKS"
  "USEROPT_USE_RECTANGULAR_RADAR_INDICATOR_FOR_SHIPS"
  "USEROPT_RADAR_TARGET_CYCLING"
  "USEROPT_RADAR_SELECTED_TARGET_FOLLOWING_IN_TARGET_CYCLING"
  "USEROPT_RADAR_AIM_ELEVATION_CONTROL"
  "USEROPT_RWR_SENSITIVITY"
  "USEROPT_RWR_FRIENDLY_TARGETS_INDICATION"
  "USEROPT_USE_RADAR_HUD_IN_COCKPIT"
  "USEROPT_USE_TWS_HUD_IN_COCKPIT"
  "USEROPT_SLAVE_AIRBORNE_COUNTER_MEASURES_TO_MLWS_ON_SPAWN"
  ...
  "USEROPT_ACTIVATE_BOMBS_AUTO_RELEASE_ON_SPAWN"
  "USEROPT_AUTOMATIC_EMPTY_CONTAINERS_JETTISON"
  "USEROPT_IGNORE_BAD_WEATHER"
  "USEROPT_SAVE_AIRCRAFT_SPAWN"
  "USEROPT_RADAR_MODE_SELECT"
  "USEROPT_RADAR_SCAN_PATTERN_SELECT"
  "USEROPT_RADAR_SCAN_RANGE_SELECT"
  "USEROPT_RADAR_MODE_SELECTED_UNIT_SELECT"
  "USEROPT_RADAR_SCAN_PATTERN_SELECTED_UNIT_SELECT"
  ...
  "USEROPT_SHOW_COMPASS_IN_AIRCRAFT_HUD"
  "USEROPT_SHOW_COMPASS_IN_HELICOPTER_HUD"
  ...
  "USEROPT_CAN_QUEUE_TO_SMALL_TEAMS_BATTLES"
  "USEROPT_CAN_QUEUE_TO_BULLET_HELL_BATTLES"
  "USEROPT_CAN_QUEUE_TO_CLASSIC_NAVAL_AB_BATTLES"
  "USEROPT_CAN_QUEUE_TO_CLASSIC_NAVAL_RB_BATTLES"
  "USEROPT_CAN_QUEUE_TO_NAVAL_EC_AB_BATTLES"
  "USEROPT_CAN_QUEUE_TO_NAVAL_EC_RB_BATTLES"
  "USEROPT_CAN_QUEUE_TO_AIR_RB_CLASSIC_BATTLES"
  "USEROPT_CAN_QUEUE_TO_AIR_RB_NUCLEAR_ESCALATION_BATTLES"
  "USEROPT_HELI_COCKPIT_HUD_DISABLED"
  "USEROPT_CUSTOM_SOUND_MODS"
  "USEROPT_XRAY_FILTER_TANK"
  "USEROPT_XRAY_FILTER_SHIP"
  "TANK_SIGHT_SETTINGS"
  "USEROPT_TEST_FLIGHT_NAME"
  "USEROPT_AIR_SPAWN_POINT"
  "USEROPT_TARGET_RANK"
  "USEROPT_SHOW_MESSAGE_MISSILE_EVADE"
  "USEROPT_HOLD_BUTTON_FOR_TACTICAL_MAP"
  "USEROPT_SHOW_HUD_MAP_TOOLTIP"
  "USEROPT_SHOW_HIT_ICONS_SHIP"
  "USEROPT_HELI_MOUSE_AIM_ROLL_OVERRIDE_ENABLED"
  "USEROPT_HOLD_THROTTLE_FOR_WEP"
  "USEROPT_SHOW_DEMONSTRATED_SHELL"
  "USEROPT_SHOW_DEMONSTRATED_SHELL_TANK"
  "USEROPT_HANGAR_SCENE"
  "USEROPT_SOUND_TEST_HEADPHONES"
  "USEROPT_INFANTRY_USE_NEOCLASSICAL_TILT"
  "USEROPT_ENABLE_HUMAN_AIM_ASSIST"
  "USEROPT_XRAY_FILTER_AIR"
]
