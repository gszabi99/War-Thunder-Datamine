...
let getMainOptions = function() {
  ...
  return {
    ...
    options = [
      ...
      [::USEROPT_XRAY_DEATH, "spinner", hasFeature("Tanks") && hasFeature("XrayDeath")],
      [::USEROPT_XRAY_KILL, "spinner", hasFeature("Tanks") && hasFeature("XrayKill")],
      [::USEROPT_TANK_GUNNER_CAMERA_FROM_SIGHT, "spinner",
        hasFeature("Tanks") && ( ! ::is_in_flight() || ! ::is_tank_gunner_camera_from_sight_available())],
      [::USEROPT_SHOW_DESTROYED_PARTS, "spinner", hasFeature("Tanks")],
      [::USEROPT_ACTIVATE_GROUND_RADAR_ON_SPAWN, "spinner", hasFeature("Tanks")],
      [::USEROPT_GROUND_RADAR_TARGET_CYCLING, "spinner", hasFeature("Tanks")],
      [::USEROPT_ACTIVATE_GROUND_ACTIVE_COUNTER_MEASURES_ON_SPAWN, "spinner", hasFeature("Tanks")],
      ...
      [::USEROPT_USE_PERFECT_RANGEFINDER, "spinner", hasFeature("Ships")],
      [::USEROPT_SAVE_AI_TARGET_TYPE, "spinner", hasFeature("Ships")],
      [::USEROPT_DEFAULT_AI_TARGET_TYPE, "spinner", hasFeature("Ships")],
      [::USEROPT_DEFAULT_TORPEDO_FORESTALL_ACTIVE, "spinner", hasFeature("Ships")],
      [::USEROPT_BULLET_FALL_INDICATOR_SHIP, "spinner", hasFeature("Ships")],
      [::USEROPT_BULLET_FALL_SPOT_SHIP, "spinner", hasFeature("Ships")],
      [::USEROPT_BULLET_FALL_SOUND_SHIP, "spinner", hasFeature("Ships")],
      [::USEROPT_AUTO_TARGET_CHANGE_SHIP, "spinner", hasFeature("Ships")],
      [::USEROPT_REALISTIC_AIMING_SHIP, "spinner", hasFeature("Ships")
      ...
      [::USEROPT_FOLLOW_BULLET_CAMERA, "spinner", hasFeature("Ships") && hasFeature("enableFollowBulletCamera")],
