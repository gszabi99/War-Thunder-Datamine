...
from "tankSightSettings" import TSI_RANGE_TEXT_COLOR, TSI_RANGE_BACK_COLOR, TSI_RANGE_NV_TEXT_COLOR, TSI_RANGE_NV_BACK_COLOR, TSI_RANGE_LTEXT_COLOR, TSI_RANGE_LBACK_COLOR, TSI_RANGE_TEXT_SIZE
  , TSI_TURRET_VISIBLE, TSI_TURRET_COLOR, TSI_TURRET_LIGHT_COLOR, TSI_TURRET_NV_COLOR, TSI_FOV_VISIBLE, TSI_FOV_COLOR, TSI_FOV_LIGHT_COLOR
  , TSI_FOV_NV_COLOR, TSI_GUN_READY_VISIBLE, TSI_GUN_READY_TEXT_SIZE, TSI_GUN_READY_COLOR, TSI_GUN_READY_LIGHT_COLOR, TSI_GUN_READY_NV_COLOR, TSO_RANGEFINDER
  , TSO_TURRET, TSO_FOV, TSO_GUN_READY, TSI_RANGE_TH_TEXT_COLOR, TSI_RANGE_TH_BACK_COLOR, TSI_TURRET_TH_COLOR, TSI_FOV_THERMAL_COLOR
  , TSI_GUN_READY_TH_COLOR, TSI_CROSSHAIR, TSO_CROSSHAIR, TSI_RANGEFINDER_VISIBLE, TSI_RANGEFINDER_FONT, TSI_CROSSHAIR_COLOR, TSI_CROSSHAIR_L_COLOR
  , TSI_CROSSHAIR_NV_COLOR, TSI_CROSSHAIR_TH_COLOR, TSI_GUN_READY_FONT, TSI_GUN_READY_MARK_VISIBLE, TSI_GUN_RELOAD_COUNTDOWN_VISIBLE, TSI_BULLET_TYPE_VISIBLE, TSI_BULLET_TYPE_SHORT
  , TSI_BULLET_TYPE_TEXT_COLOR, TSI_BULLET_TYPE_BACK_COLOR, TSI_BULLET_TYPE_NV_TEXT_COLOR, TSI_BULLET_TYPE_NV_BACK_COLOR, TSI_BULLET_TYPE_LTEXT_COLOR, TSI_BULLET_TYPE_LBACK_COLOR, TSI_BULLET_TYPE_TH_TEXT_COLOR
  , TSI_BULLET_TYPE_TH_BACK_COLOR, TSI_BULLET_TYPE_TEXT_SIZE, TSI_BULLET_TYPE_FONT, TSO_BULLET_TYPE, TSI_RANGEFINDER_PROGRESS_COLOR, TSI_RANGEFINDER_PROGRESS_BACKGROUND_COLOR, TSO_RETICLE
  , TSI_RETICLE_OVERRIDE, TSI_RETICLE_LINE_WIDTH, TSI_RETICLE_FONT_SIZE
from "crosshair" import has_forced_crosshair, get_user_alt_crosshairs
