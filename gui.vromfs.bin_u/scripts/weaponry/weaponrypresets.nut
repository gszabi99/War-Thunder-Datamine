...
const INF_VIEW_SIZE_MULTIPLIER = 1.25

const CUSTOM_PRESET_PREFIX = "custom"
const EMPTY_PRESET_NAME = "empty"

let CHAPTER_ORDER = ["NONE", "FAVORITE", "UNIVERSAL", "AIR_TO_AIR", "AIR_TO_GROUND", "AIR_TO_RADAR", "AIR_TO_SEA", "ARMORED", "CUSTOM"]
