...
::g_world_war <- {
  ...
  function getInfantryUnits()
  {
    if (infantryUnits == null)
      infantryUnits = this.getWWConfigurableValue("infantryUnits", infantryUnits)
  ...
  function getArtilleryUnits()
  {
    if (artilleryUnits == null)
      artilleryUnits = this.getWWConfigurableValue("artilleryUnits", artilleryUnits)
  ...
  function getTransportUnits()
  {
    if (transportUnits == null)
      transportUnits = this.getWWConfigurableValue("transportUnits", transportUnits)
