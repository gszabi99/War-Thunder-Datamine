...
foreach (fn in [
  ...
  "scripts/debugTools/dbgCheckContent.nut"
  "scripts/debugTools/dbgUnlocks.nut"
  "scripts/debugTools/dbgClans.nut"
  "scripts/debugTools/dbgHud.nut"
  "scripts/debugTools/dbgHudObjects.nut"
  "scripts/debugTools/dbgHudObjectTypes.nut"
  "scripts/debugTools/dbgVoiceChat.nut"
