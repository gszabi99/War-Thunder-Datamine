...
return {
  ...
  TARGET_HUE_HELICOPTER_PARAM_HUD = 8
  TARGET_HUE_HELICOPTER_MFD = 9

  TARGET_HUE_AIRCRAFT_HUD = 10
  TARGET_HUE_AIRCRAFT_PARAM_HUD = 11

  TARGET_HUE_HELICOPTER_HUD_ALERT_LOW = 12
  TARGET_HUE_HELICOPTER_HUD_ALERT_MEDIUM = 13
  TARGET_HUE_HELICOPTER_HUD_ALERT_HIGH = 14
  TARGET_HUE_AIRCRAFT_HUD_ALERT_LOW = 15
  TARGET_HUE_AIRCRAFT_HUD_ALERT_MEDIUM = 16
  TARGET_HUE_AIRCRAFT_HUD_ALERT_HIGH = 17
