...
local curEntityComponents = ::mkWatched(persist, "curEntityComponents", selectedEntity.value!=null ? {} : ::ecs._dbg_get_all_comps(selectedEntity.value))

selectedEntity.subscribe(function(eid){
  ::gui_scene.setTimeout(0.1, @() curEntityComponents(::ecs._dbg_get_all_comps(selectedEntity.value)))
})
